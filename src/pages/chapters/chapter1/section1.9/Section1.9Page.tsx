...
export default function SectionPage({
  ...
  return (
    <div className="page-container">
      ...
      <button>
        <Link to="/section1.9/example05">Example 05</Link>
      </button>
      <h2 className="pt-6 text-xl">Example 06: ?</h2>
      <button>
        <Link to="/section1.9/example06">Example 06</Link>
      </button>
      <h2 className="pt-6 text-xl">Example 07: ?</h2>
      <button>
        <Link to="/section1.9/example07">Example 07</Link>
      </button>
      <h2 className="pt-6 text-xl">Example 08: ?</h2>
      <button>
        <Link to="/section1.9/example08">Example 08</Link>
      </button>
      <h2 className="pt-6 text-xl">Example 09: ?</h2>
      <button>
        <Link to="/section1.9/example09">Example 09</Link>
      </button>
      <h2 className="pt-6 text-xl">Example 10: ?</h2>
      <button>
        <Link to="/section1.9/example10">Example 10</Link>
      </button>
    </div>
  );
}
